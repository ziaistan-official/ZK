...
public final class KeyValue implements Comparable<KeyValue>
{
  ...
  public static KeyValue getSpecialKeyByName(String name)
  {
    switch (name)
    {
      ...
      case "move_word_backward_1": return editingKey("W-", Editing.MOVE_WORD_BACKWARD_1);
      case "move_word_forward_1": return editingKey("W+", Editing.MOVE_WORD_FORWARD_1);
      case "move_word_backward_2": return editingKey("W--", Editing.MOVE_WORD_BACKWARD_2);
      case "move_word_forward_2": return editingKey("W++", Editing.MOVE_WORD_FORWARD_2);
      case "move_word_backward_3": return editingKey("W---", Editing.MOVE_WORD_BACKWARD_3);
      case "move_word_forward_3": return editingKey("W+++", Editing.MOVE_WORD_FORWARD_3);
      case "move_word_backward_4": return editingKey("W----", Editing.MOVE_WORD_BACKWARD_4);
      case "move_word_forward_4": return editingKey("W++++", Editing.MOVE_WORD_FORWARD_4);
      case "move_word_backward_5": return editingKey("W-----", Editing.MOVE_WORD_BACKWARD_5);
      case "move_word_forward_5": return editingKey("W+++++", Editing.MOVE_WORD_FORWARD_5);
