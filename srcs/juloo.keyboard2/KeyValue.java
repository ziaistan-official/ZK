...
public final class KeyValue implements Comparable<KeyValue>
{
  ...
  /** Defined only when [getKind() == Kind.Char] or [getKind() == Kind.ModifiedChar]. */
  public char getChar()
  {
    return (char)(_code & VALUE_BITS);
  }

  /** Defined only when [getKind() == Kind.ModifiedChar]. */
  ...
  public static KeyValue getSpecialKeyByName(String name)
  {
    switch (name)
    {
      ...
      case "move_word_backward_1": return editingKey("◀️", Editing.MOVE_WORD_BACKWARD_1);
      case "move_word_forward_1": return editingKey("▶️", Editing.MOVE_WORD_FORWARD_1);
      case "move_word_backward_2": return editingKey("◀️", Editing.MOVE_WORD_BACKWARD_2);
      case "move_word_forward_2": return editingKey("▶️", Editing.MOVE_WORD_FORWARD_2);
      case "move_word_backward_3": return editingKey("◀️", Editing.MOVE_WORD_BACKWARD_3);
      case "move_word_forward_3": return editingKey("▶️", Editing.MOVE_WORD_FORWARD_3);
      case "move_word_backward_4": return editingKey("◀️", Editing.MOVE_WORD_BACKWARD_4);
      case "move_word_forward_4": return editingKey("▶️", Editing.MOVE_WORD_FORWARD_4);
      case "move_word_backward_5": return editingKey("◀️", Editing.MOVE_WORD_BACKWARD_5);
      case "move_word_forward_5": return editingKey("▶️", Editing.MOVE_WORD_FORWARD_5);
